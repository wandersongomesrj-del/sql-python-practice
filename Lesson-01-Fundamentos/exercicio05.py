...
esses nomes. O objetivo final é garantir que o sistema de crachás e os registros internos recebam os
nomes formatados corretamente, assegurando a padronização necessária.
"""
### Tarefa
"""
...
requerida, sendo a combinação do nome simplificado formatado, seguido de três hífens, e então o nome
completo também já formatado. O programa deve exibir essas três versões padronizadas do nome.
"""
...
print("Nome completo: ", nome_completo_formatado)
print("Cracha: ", nome_cracha_formatado)
print("identificação: ", identificação)
